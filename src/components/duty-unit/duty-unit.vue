<template>
  <div class="big-layout">
    ...
    <div class="layout">
      <!--tab切换-->
      <ul class="tab-router">
        <li v-for="(i ,index) in arr" :class="{isChecked:c_index==index}" class="pointer"
            v-on:click="isChoosed($event, index, i)">
          {{i}}
      ...
      <div :index="0" v-if="c_index==0" class="lists_wrapper">
        ...
        <div class="chart-show" :class="{back:isBack}">
          ...
          <div v-on:click="backMenu" v-show="c_index!=5" class="toggle_menu pointer"><span class="iconfont"
        ...
        <my-tab>
          <div slot="left">
            <span class="tab pointer active float_left">人员考核总分</span>
          </div>
          <div slot="right">
        ...
        <div>
          <ul class="item_title clearfix">
            ...
            <li class="float_left web_lis">责任单位</li>
          ...
          <ul v-for="i in 20" :class="{deep: isChecked}" class="item_list pointer clearfix">
            ...
            <li class="float_left source team">白云区公安分队</li>
      ...
      <div :index="1" v-else-if="c_index==1" class="lists_wrapper">
        ...
        <div>
          <ul class="item_title clearfix">
            <li class="float_left check_all"><input type="checkbox"></li>
            <li class="float_left duty-unit">责任单位</li>
          ...
          <ul v-for="i in 20" :class="{deep: isChecked}" class="item_list pointer clearfix">
            <li class="float_left input"><input type="checkbox" class="pointer"></li>
            <li class="float_left source duty-unit">深圳市</li>
            <li class="float_left title duty-area">网站：新浪、腾讯</li>
            <li class="float_left duty-num center ">18</li>
            <li class="float_left total-duty-num type center ">18</li>
            <li class="float_left leave-times center">1</li>
            <li class="float_left miss-num center">12</li>
            <li class="float_left total-scrope center">85</li>
          </ul>
        </div>
        <PageTurn :totalPage="totalPage"></PageTurn>
      </div>
      ...
      <div :index="2" v-else-if="c_index==2" class="lists_wrapper">
        ...
        <div>
          <ul class="item_title clearfix">
            <li class="float_left check_all"><input type="checkbox"></li>
            <li class="float_left t-duty-unit">责任单位</li>
            <li class="float_left send-num">总报送数</li>
            <li class="float_left accept-num">被采分数</li>
            <li class="float_left t-scrope">得分</li>
          </ul>
          <ul v-for="i in 20" :class="{deep: isChecked}" class="item_list pointer clearfix">
            <li class="float_left input"><input type="checkbox" class="pointer"></li>
            <li class="float_left t-duty-unit">广州市</li>
            <li class="float_left send-num">1</li>
            <li class="float_left accept-num">12</li>
            <li class="float_left t-scrope">85</li>
          </ul>
        </div>
        <PageTurn :totalPage="totalPage"></PageTurn>
      </div>
      ...
      <div :index="3" v-else-if="c_index==3" class="lists_wrapper">
        ...
        <div>
          <ul class="item_title clearfix">
            <li class="float_left check_all"><input type="checkbox"></li>
            <li class="float_left d-duty-unit">责任单位</li>
            ...
            <li class="float_left d-total-scrope">总分</li>
          </ul>
          <ul v-for="i in 20" :class="{deep: isChecked}" class="item_list pointer clearfix">
            <li class="float_left input"><input type="checkbox" class="pointer"></li>
            <li class="float_left d-duty-unit">珠海市</li>
            <li class="float_left land-research">25</li>
            <li class="float_left harmful-info">6</li>
            <li class="float_left info-research">11</li>
            <li class="float_left situaton-control">22</li>
            <li class="float_left other-task">9</li>
            <li class="float_left d-total-scrope">79</li>
          </ul>
        </div>
        <PageTurn :totalPage="totalPage"></PageTurn>
      </div>
      ...
      <div :index="4" v-else-if="c_index==4" class="lists_wrapper">
        ...
        <div>
          <ul class="item_title clearfix">
            <li class="float_left check_all"><input type="checkbox"></li>
            <li class="float_left f-duty-unit">责任单位</li>
            ...
            <li class="float_left f-total-scrope">总分</li>
          </ul>
          <ul v-for="i in 20" :class="{deep: isChecked}" class="item_list pointer clearfix">
            <li class="float_left input"><input type="checkbox" class="pointer"></li>
            <li class="float_left f-duty-unit">佛山市</li>
            <li class="float_left web-bill">25</li>
            <li class="float_left key-bill">6</li>
            <li class="float_left person-bill">11</li>
            <li class="float_left event-bill">22</li>
            <li class="float_left terror-acount">9</li>
            <li class="float_left f-total-scrope">79</li>
          </ul>
        </div>
        <PageTurn :totalPage="totalPage"></PageTurn>
      </div>
      ...
      <div :index="5" v-else-if="c_index==5" class="lists_wrapper">
        ...
        <div class="chart-show" :class="{back:isBack}">
          <transition name="slider-fade">
            <div v-show="!isBack" class="chart-content" style="height: 0;">6</div>
          </transition>
          <div class="bd" v-show="!c_index==5"></div>
          <div v-on:click="backMenu" v-show="!c_index==5" class="toggle_menu pointer"><span class="iconfont"
                                                                                            :class="{'icon-shuangjiantouxia4':isBack, 'icon-shuangjiantouxia3': !isBack}"></span>
          </div>
        </div>
        ...
        <div>
          <ul class="item_title clearfix">
            <li class="float_left check_all"><input type="checkbox"></li>
            <li class="float_left k-duty-unit">责任单位</li>
            ...
            <li class="float_left k-total-scrope">总分</li>
          </ul>
          <ul v-for="i in 20" :class="{deep: isChecked}" class="item_list pointer clearfix">
            <li class="float_left input"><input type="checkbox" class="pointer"></li>
            <li class="float_left k-duty-unit">广州市</li>
            ...
            <li class="float_left k-total-scrope"><input class="input_nums" type="text" v-show="!isSeen" @change="getNum"><span
  ...
  export default {
    ...
    data () {
      return {
        ...
        isChecked: false,
        isBack: false,
        arr: ['总分', '责任巡查', '信息报送', '处置任务', '档案资料', '考核扣分'],
        c_index: 0,
        isSeen: true,
        num1: 12,
        num2: 41,
...
//                inverse: true,
      ...
      getWord(e){
        if(e.currentTarget.name=='dutyPerson_zf'){
          this.condition_data.dutyPerson_zf = e.currentTarget.value
        }else if(e.currentTarget.name=='dutyPerson_xc'){
          this.condition_data.dutyPerson_xc = e.currentTarget.value
        }else if(e.currentTarget.name=='dutyPerson_bs'){
          this.condition_data.dutyPerson_bs = e.currentTarget.value
        }else if(e.currentTarget.name=='dutyPerson_rw'){
          this.condition_data.dutyPerson_rw = e.currentTarget.value
        }else if(e.currentTarget.name=='dutyPerson_zl'){
          this.condition_data.dutyPerson_zl = e.currentTarget.value
        }else if(e.currentTarget.name=='dutyPerson_kf'){
          this.condition_data.dutyPerson_kf = e.currentTarget.value
        }
